...
public class MecDrive implements cmd {
	 
	RobotDrive driveTrain;
	JsScaled driveStick;
	
	public MecDrive(SpeedController frontLeftMotor, SpeedController frontRightMotor, SpeedController backLeftMotor,
	...
	public MecDrive(int frontLeftMotor, int frontRightMotor, int backLeftMotor, int backRightMotor, JsScaled driveStick){
		driveTrain = new RobotDrive(frontLeftMotor, frontRightMotor, backLeftMotor, backRightMotor);
		this.driveStick = driveStick;
	}
